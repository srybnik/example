...
/*
Package foo_service is a reverse proxy.
...
// RegisterFooServiceHandlerServer registers the http handlers for services FooService to "mux".
...
func RegisterFooServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FooServiceServer) error {
	...
	mux.Handle("POST", pattern_FooService_Foo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.foo_service.FooService/Foo", runtime.WithHTTPPathPattern("/v1/example/foo"))
		if err != nil {
...
// RegisterFooServiceHandler registers the http handlers for services FooService to "mux".
...
// RegisterFooServiceHandlerClient registers the http handlers for services FooService
...
func RegisterFooServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FooServiceClient) error {
	...
	mux.Handle("POST", pattern_FooService_Foo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.foo_service.FooService/Foo", runtime.WithHTTPPathPattern("/v1/example/foo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
